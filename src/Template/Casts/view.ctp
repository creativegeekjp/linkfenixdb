<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Cast'), ['action' => 'edit', $cast->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Cast'), ['action' => 'delete', $cast->id], ['confirm' => __('Are you sure you want to delete # {0}?', $cast->id)]) ?> </li>
...
<div class="casts view large-9 medium-8 columns content">
    <h3><?= h($cast->name) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($cast->movies as $movies): ?>
            <tr>
                <td><?= h($movies->id) ?></td>
                <td><?= h($movies->name) ?></td>
                <td><?= h($movies->year) ?></td>
